                    ...
                    <?php
				        foreach($htls as $htl)
				        {
                            echo "<tr>";
                                echo "<td>".$htl["h_id"]."</td>";
                                echo "<td>".$htl["name"]."</td>";
                                echo "<td>".$htl["location"]."</td>";
                                echo "<td>".$htl["room_no"]."</td>";
                                echo "<td>".$htl["price"]."</td>";
                                echo "<td>".$htl["count"]."</td>";
                                echo "<td>".$htl["details"]."</td>";
                                echo "<td>".$htl["ref"]."</td>";
                                echo '<td><a href="updatehotel.php?id='.$htl["h_id"].'" class="btn1 btn1-success">Edit</a></td>';
                            echo "</tr>";
				        }
			        ?>
