        ...
        <div id="table-scroll">
            ...
            <table>
                    ...
                    <?php
				        ...
				        {
                            echo "<tr>";
                                echo "<td>".$tran["tr_id"]."</td>";
                                echo "<td>".$tran["name"]."</td>";
                                echo "<td>".$tran["type"]."</td>";
                                echo "<td>".$tran["traveldate"]."</td>";
                                echo "<td>".$tran["location_f"]."</td>";
                                echo "<td>".$tran["location_t"]."</td>";
                                echo "<td>".$tran["ref"]."</td>";
                                echo "<td>".$tran["seat_no"]."</td>";
                                echo "<td>".$tran["price"]."</td>";
                                echo "<td>".$tran["details"]."</td>";
                                echo "<td>".$tran["count"]."</td>";
                                echo '<td><a href="updatetransport.php?id='.$tran["tr_id"].'" class="btn1 btn1-success">Edit</a></td>';
                            echo "</tr>";
				        }
			        ?>  
        </table>
